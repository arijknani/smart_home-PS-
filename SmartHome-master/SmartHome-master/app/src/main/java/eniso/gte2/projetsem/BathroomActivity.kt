...
import eniso.gte2.projetsem.databinding.ActivityBathroomBinding
...
class BathroomActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ActivityBathroomBinding.inflate(layoutInflater)
        ...
        binding.switch3.setOnClickListener{
            if(binding.switch3.isChecked){
                ...
                binding.imageView5.setImageResource(R.drawable.img_2)
            }
        }
    ...
    private fun getdata() {
        var getdata= object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                val builder = AlertDialog.Builder(this@BathroomActivity)
                val builder1 = AlertDialog.Builder(this@BathroomActivity)
